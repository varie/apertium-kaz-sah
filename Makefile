...
pkgdatadir = $(datadir)/apertium-kaz-sah
pkgincludedir = $(includedir)/apertium-kaz-sah
pkglibdir = $(libdir)/apertium-kaz-sah
pkglibexecdir = $(libexecdir)/apertium-kaz-sah
...
am__installdirs = "$(DESTDIR)$(apertium_kaz_sahdir)"
DATA = $(apertium_kaz_sah_DATA) $(noinst_DATA)
...
ACLOCAL = ${SHELL} /Users/varie/Documents/apertium/gsoc/sah-kaz/apertium-kaz-sah/missing aclocal-1.15
AMTAR = $${TAR-tar}
...
APERTIUM_SAH_CFLAGS = 
APERTIUM_SAH_LIBS = 
AP_LIB1 = ../apertium-kaz
AP_LIB2 = ../apertium-sah
AP_SRC1 = ../apertium-kaz
AP_SRC2 = ../apertium-sah
AP_SUBDIRS =  ../apertium-kaz ../apertium-sah
AUTOCONF = ${SHELL} /Users/varie/Documents/apertium/gsoc/sah-kaz/apertium-kaz-sah/missing autoconf
AUTOHEADER = ${SHELL} /Users/varie/Documents/apertium/gsoc/sah-kaz/apertium-kaz-sah/missing autoheader
AUTOMAKE = ${SHELL} /Users/varie/Documents/apertium/gsoc/sah-kaz/apertium-kaz-sah/missing automake-1.15
AWK = gawk
CGCOMP = /usr/local/bin/cg-comp
CGPROC = /usr/local/bin/cg-proc
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"Apertium\ Kazakh-Sakha\" -DPACKAGE_TARNAME=\"apertium-kaz-sah\" -DPACKAGE_VERSION=\"0.2.0\" -DPACKAGE_STRING=\"Apertium\ Kazakh-Sakha\ 0.2.0\" -DPACKAGE_BUGREPORT=\"despairchasm@gmail.com\" -DPACKAGE_URL=\"http://wiki.apertium.org/wiki/Apertium-kaz-sah\" -DPACKAGE=\"apertium-kaz-sah\" -DVERSION=\"0.2.0\"
ECHO_C = \c
ECHO_N = 
ECHO_T = 
...
LTLIBOBJS = 
MAKEINFO = ${SHELL} /Users/varie/Documents/apertium/gsoc/sah-kaz/apertium-kaz-sah/missing makeinfo
MKDIR_P = ./install-sh -c -d
PACKAGE = apertium-kaz-sah
PACKAGE_BUGREPORT = despairchasm@gmail.com
PACKAGE_NAME = Apertium Kazakh-Sakha
PACKAGE_STRING = Apertium Kazakh-Sakha 0.2.0
PACKAGE_TARNAME = apertium-kaz-sah
PACKAGE_URL = http://wiki.apertium.org/wiki/Apertium-kaz-sah
...
VERSION = 0.1.0
ZCAT = /usr/bin/gzcat
abs_builddir = /Users/varie/Documents/apertium/gsoc/sah-kaz/apertium-kaz-sah
abs_srcdir = /Users/varie/Documents/apertium/gsoc/sah-kaz/apertium-kaz-sah
abs_top_builddir = /Users/varie/Documents/apertium/gsoc/sah-kaz/apertium-kaz-sah
abs_top_srcdir = /Users/varie/Documents/apertium/gsoc/sah-kaz/apertium-kaz-sah
am__leading_dot = .
...
install_sh = ${SHELL} /Users/varie/Documents/apertium/gsoc/sah-kaz/apertium-kaz-sah/install-sh
...
###############################################################################
###############################################################################
apertium_kaz_sahdir = $(prefix)/share/apertium/$(BASENAME)/

# Files which should be installed to $(prefix)/share/apertium/$(BASENAME)/:
apertium_kaz_sah_DATA = \
	$(TARGETS_COMMON)				\
	$(BASENAME).$(PREFIX1).t1x			\
	$(BASENAME).$(PREFIX1).t2x			\
	$(BASENAME).$(PREFIX1).t3x			\
...
$(am__aclocal_m4_deps):
install-apertium_kaz_sahDATA: $(apertium_kaz_sah_DATA)
	@$(NORMAL_INSTALL)
	@list='$(apertium_kaz_sah_DATA)'; test -n "$(apertium_kaz_sahdir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(apertium_kaz_sahdir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(apertium_kaz_sahdir)" || exit 1; \
	fi; \
	for p in $$list; do \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(apertium_kaz_sahdir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(apertium_kaz_sahdir)" || exit $$?; \
	done

uninstall-apertium_kaz_sahDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(apertium_kaz_sah_DATA)'; test -n "$(apertium_kaz_sahdir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(apertium_kaz_sahdir)'; $(am__uninstall_files_from_dir)
tags TAGS:
...
installdirs:
	for dir in "$(DESTDIR)$(apertium_kaz_sahdir)"; do \
...
install-data-am: install-apertium_kaz_sahDATA install-data-local
...
uninstall-am: uninstall-apertium_kaz_sahDATA
...
.PHONY: all all-am am--refresh check check-am clean clean-generic \
	...
	install install-am install-apertium_kaz_sahDATA install-data \
...
test: all
	echo "house" | apertium -d . kaz-sah | tee .test-mt
	@echo "house" > .test-ref
	@diff .test-ref .test-mt
	echo "house" | apertium -d . sah-kaz | tee .test-mt
	@echo "house" > .test-ref
	@diff .test-ref .test-mt
	@rm .test-ref .test-mt
